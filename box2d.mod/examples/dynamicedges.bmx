...
Run(New DynamicEdges.Create(), New TSettings)


Type DynamicEdges Extends Test

	Method Create:DynamicEdges()
		...
		xf1.R.SetAngle(63.43200)
		xf1.SetPosition(b2Mul(xf1.R, Vec2(1.0, 0.0)))
		...
		xf2.R.SetAngle(63.43200)
		xf2.SetPosition(b2Mul(xf2.R, Vec2(-1.0, 0.0)))
